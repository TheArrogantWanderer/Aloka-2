...
const MOCK_DATA = {
  All: [
    ...
    { id:"m3", category:"Business", source:"Financial Times", bias:"Centre", time:"28m ago", headline:"Global markets rally as US Federal Reserve signals pause in rate hikes", description:"Stock markets surged worldwide after Federal Reserve minutes revealed policymakers are leaning toward holding interest rates steady.", url:"#" },
    { id:"m4", category:"Politics", source:"BBC News", bias:"Centre", time:"45m ago", headline:"European Parliament passes landmark digital identity legislation", description:"The EU's new digital identity framework gives all 450 million citizens a unified digital wallet for government services, banking, and healthcare.", url:"#" },
    ...
    { id:"m7", category:"Sport", source:"ESPN", bias:"Centre", time:"2h ago", headline:"FIFA confirms 2030 World Cup will span three continents for centenary celebration", description:"Football's governing body confirmed the 2030 World Cup will be hosted across Spain, Portugal, Morocco, Argentina, Uruguay, and Paraguay.", url:"#" },
    { id:"m8", category:"Entertainment", source:"Variety", bias:"Centre-Left", time:"3h ago", headline:"Netflix's most-watched original film breaks 200 million views in record time", description:"The streaming giant's latest thriller surpassed 200 million views in just 18 days, shattering the platform's previous record.", url:"#" },
  ],
  World: [
    { id:"m101", category:"World", source:"Reuters", bias:"Centre", time:"5m ago", headline:"United Nations Security Council votes on emergency ceasefire resolution", description:"The UN Security Council convened an emergency session with diplomatic tensions running high among permanent members.", url:"#" },
    ...
    { id:"m103", category:"World", source:"BBC News", bias:"Centre", time:"1h ago", headline:"China and India agree to resume high-level diplomatic talks after border standoff", description:"Following months of tensions along disputed Himalayan borders, both nations announced a renewed diplomatic channel.", url:"#" },
    { id:"m104", category:"World", source:"Associated Press", bias:"Centre", time:"2h ago", headline:"Global refugee numbers reach record 120 million for third consecutive year", description:"The UNHCR's annual report confirmed forced displacement has hit a historic high for the third year running.", url:"#" },
  ],
  Tech: [
    { id:"m201", category:"Tech", source:"The Verge", bias:"Centre-Left", time:"8m ago", headline:"OpenAI releases GPT-5 with real-time reasoning and 1M token context window", description:"OpenAI's flagship model launch sets a new benchmark in AI capability with native multimodal reasoning.", url:"#" },
    { id:"m202", category:"Tech", source:"Wired", bias:"Centre-Left", time:"31m ago", headline:"Google's quantum computer solves problem that would take classical machines 47 years", description:"Google DeepMind announced a quantum computing breakthrough demonstrating practical quantum advantage.", url:"#" },
    { id:"m203", category:"Tech", source:"TechCrunch", bias:"Centre", time:"55m ago", headline:"Startup raises $400M to build the world's first fully autonomous AI software engineer", description:"The San Francisco-based startup claims its AI can independently build, test, and deploy production-grade software.", url:"#" },
    { id:"m204", category:"Tech", source:"MIT Technology Review", bias:"Centre", time:"3h ago", headline:"New battery chemistry achieves 1,000 charge cycles with zero capacity loss", description:"Researchers at Stanford developed a lithium-metal battery variant that maintains full capacity across a thousand charge cycles.", url:"#" },
  ],
  Business: [
    { id:"m301", category:"Business", source:"Financial Times", bias:"Centre", time:"12m ago", headline:"Amazon acquires logistics startup in $4.2B deal to compete with FedEx", description:"Amazon's latest acquisition signals an aggressive push to build end-to-end logistics independence.", url:"#" },
    ...
    { id:"m303", category:"Business", source:"Bloomberg", bias:"Centre", time:"1h ago", headline:"Tesla's energy division now generates more revenue than its auto business", description:"For the first time in company history, Tesla's energy storage and solar division outpaced vehicle sales in quarterly revenue.", url:"#" },
  ],
  Politics: [
    { id:"m401", category:"Politics", source:"BBC News", bias:"Centre", time:"15m ago", headline:"UK Prime Minister announces snap general election for September", description:"In a surprise announcement from Downing Street, the Prime Minister called a general election two years ahead of schedule.", url:"#" },
    { id:"m402", category:"Politics", source:"NPR", bias:"Centre-Left", time:"1h ago", headline:"US Senate passes bipartisan infrastructure bill with $1.2 trillion in spending", description:"The rare show of bipartisan cooperation delivers the largest infrastructure investment in American history.", url:"#" },
    { id:"m403", category:"Politics", source:"The Economist", bias:"Centre", time:"3h ago", headline:"France's ruling coalition collapses ahead of budget vote", description:"The French government faces a constitutional crisis after coalition partners withdrew support over austerity measures.", url:"#" },
  ],
  Sport: [
    { id:"m501", category:"Sport", source:"ESPN", bias:"Centre", time:"20m ago", headline:"Lionel Messi announces retirement from international football at 38", description:"The eight-time Ballon d'Or winner confirmed he will not participate in the next World Cup qualifying campaign.", url:"#" },
    { id:"m502", category:"Sport", source:"Sky Sports", bias:"Centre", time:"45m ago", headline:"Formula 1 confirms Las Vegas Grand Prix extended to 10-year deal", description:"The sport's fastest-growing race on the calendar has secured a long-term future with major infrastructure upgrades planned.", url:"#" },
    { id:"m503", category:"Sport", source:"BBC Sport", bias:"Centre", time:"2h ago", headline:"New Zealand All Blacks reclaim World Rugby number one ranking", description:"After a dominant series victory against the British & Irish Lions, the All Blacks returned to the top of world rugby rankings.", url:"#" },
  ],
  Health: [
    ...
    { id:"m602", category:"Health", source:"Reuters", bias:"Centre", time:"50m ago", headline:"Ozempic found to reduce cardiovascular disease risk by 20% in landmark trial", description:"A major clinical trial confirmed that semaglutide drugs reduce the risk of heart attack and stroke significantly.", url:"#" },
    { id:"m603", category:"Health", source:"BBC News", bias:"Centre", time:"2h ago", headline:"Global life expectancy hits 74 years for first time despite pandemic setback", description:"WHO data shows humanity has recovered the life expectancy gains lost during COVID-19.", url:"#" },
  ],
  Science: [
    { id:"m701", category:"Science", source:"Nature", bias:"Centre", time:"35m ago", headline:"First complete map of a human brain's neural connections published", description:"An international team published the first full connectome of a cubic millimetre of human brain tissue, mapping 57,000 cells.", url:"#" },
    { id:"m702", category:"Science", source:"Science", bias:"Centre", time:"1h ago", headline:"CRISPR gene editing reverses inherited blindness in first human trial", description:"Researchers restored functional vision in three patients with a rare inherited retinal disease using in-vivo CRISPR.", url:"#" },
    { id:"m703", category:"Science", source:"MIT Technology Review", bias:"Centre", time:"4h ago", headline:"New material absorbs 99.9% of sunlight and converts it to electricity", description:"Scientists developed a perovskite-silicon tandem solar cell achieving 47% energy conversion efficiency in lab conditions.", url:"#" },
  ],
  Entertainment: [
    { id:"m801", category:"Entertainment", source:"Variety", bias:"Centre-Left", time:"10m ago", headline:"Beyoncé's Renaissance film breaks all-time opening weekend record for a concert film", description:"The visual companion to her critically acclaimed album shattered box office records earning $92M globally.", url:"#" },
    { id:"m802", category:"Entertainment", source:"The Hollywood Reporter", bias:"Centre", time:"55m ago", headline:"Succession creator announces new HBO series set in Silicon Valley", description:"Jesse Armstrong returns with a new limited series examining power and dysfunction inside a fictional AI company.", url:"#" },
    { id:"m803", category:"Entertainment", source:"BBC Culture", bias:"Centre", time:"3h ago", headline:"The Booker Prize awarded to debut Nigerian novelist in historic first", description:"The 2026 Booker Prize was awarded to a debut novelist from Lagos, the youngest winner in the prize's 57-year history.", url:"#" },
  ],
};
...
function formatArticle(raw, cat) {
  ...
  return { id:stableId, category:cat, source:raw.author||raw.source||"Unknown", bias:getBias(raw.author||raw.source), time:raw.published?timeAgo(raw.published):"Recently", headline:raw.title||"No headline", description:raw.description||"", url:raw.url||"#", image:raw.image||null, aiSummary:null, aiLoading:false, aiFailed:false };
}
...
async function generateAISummary(headline, description, retried = false) {
  try {
    ...
    if (!data.bullets || !data.why) throw new Error("Malformed response");
    return data;
  } catch (err) {
    if (!retried) {
      await new Promise(r => setTimeout(r, 600));
      return generateAISummary(headline, description, true);
    }
    return null;
  }
}
  ...
  return (
    <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,0.96)",zIndex:50,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:14,marginBottom:28,width:"100%",maxWidth:340}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:14,background:"#1A1A1A",borderRadius:14,padding:"14px 16px"}}>
          <span style={{fontSize:24}}>👉</span>
          <div><p style={{fontSize:14,fontWeight:700,color:"#fff",margin:"0 0 2px"}}>Swipe right to read</p><p style={{fontSize:12,color:"#555",margin:0}}>Opens it inside Aloka. You can always come back.</p></div>
        </div>
        <div style={{display:"flex",alignItems:"center",gap:14,background:"#1A1A1A",borderRadius:14,padding:"14px 16px"}}>
          <span style={{fontSize:24}}>🔖</span>
        ...
        <div style={{display:"flex",alignItems:"center",gap:14,background:"#1A1A1A",borderRadius:14,padding:"14px 16px"}}>
          <span style={{fontSize:24}}>✨</span>
          <div><p style={{fontSize:14,fontWeight:700,color:"#fff",margin:"0 0 2px"}}>Tap AI Analysis</p><p style={{fontSize:12,color:"#555",margin:0}}>Get instant AI summaries, where available.</p></div>
        </div>
      </div>
...
// ── AI Summary section — hides entirely if generation fails ───────────────
function AISummarySection({article, onGenerate}) {
  const [open, setOpen] = useState(false);
  if (article.aiFailed) return null; // hide entirely once confirmed it can't generate
    ...
    <div onClick={handleToggle} style={{background:"rgba(245,166,35,0.07)",border:"1px solid rgba(245,166,35,0.2)",borderRadius:12,padding:"12px 14px",cursor:"pointer",marginBottom:16}}>
      ...
      {open&&(
        <div style={{marginTop:12}}>
          ...
          ):<p style={{fontSize:12,color:"#666",margin:0,fontFamily:"'Inter',sans-serif"}}>Generating failed. Tap to retry.</p>}
        </div>
      )}
    </div>
  );
...
function ReaderView({article, onClose, onGenerateAI, onSave}) {
  ...
  useEffect(() => {
    ...
    fetch("/api/extract", {
      ...
      .then(r => r.json())
      .then(data => { if (data.success && data.content) setFullText(data.content); setExtracting(false); })
      ...
      <div style={{flex:1,overflowY:"auto",padding:"24px 20px 60px"}}>
        ...
        {extracting ? (
          ...
          <div style={{marginBottom:24}}>
            ...
            <div style={{background:"rgba(245,166,35,0.07)",border:"1px solid rgba(245,166,35,0.2)",borderRadius:12,padding:14,marginTop:8}}>
        ...
        <div style={{marginTop:24,paddingTop:20,borderTop:"1px solid #1A1A1A"}}>
          <p style={{fontSize:12,color:"#444",marginBottom:10}}>{fullText?"Continue reading on the original site, or view as published:":"Read the complete original article:"}</p>
...
export default function AlokaApp() {
  ...
  const [articles,setArticles]=useState([]);          // full pool of loaded articles
  const [cursor,setCursor]=useState(0);                 // pointer to current top-of-stack index — never removes from articles
  ...
  const cycleIndexRef = useRef(0); // tracks which category to pull from next for infinite variety
  ...
  // Fetch a batch of articles for a given category (live or mock fallback)
  const fetchBatch=useCallback(async(category, existingIds)=>{
    ...
    const mock=dedupeArticles((MOCK_DATA[category]||MOCK_DATA["All"]).map(a=>({...a,aiSummary:null,aiLoading:false,aiFailed:false})), existingIds);
    return { items: mock, live: false };
  },[]);

  // Initial / category-switch load — resets pool and cursor
  const loadNews=useCallback(async(category)=>{
    setLoading(true);setIsLive(false);setCursor(0);
  ...
  // Infinite scroll: when cursor nears the end of the loaded pool, fetch more
  // from a rotating set of categories (Option A) so the feed never visibly ends.
  useEffect(()=>{
    if(loading || fetchingMore) return;
    const remaining = articles.length - cursor;
    if(remaining > 3) return; // plenty left, no need yet
    ...
    (async()=>{
      ...
      let newItems = [];
      let attempts = 0;
      // Try up to 3 categories in rotation until we get fresh items
      ...
      if(newItems.length > 0){
        setArticles(prev => [...prev, ...dedupeArticles(newItems, prev.map(a=>a.id))]);
      }
  ...
  const handleGenerateAI=useCallback(async(articleId)=>{
    const setFlag=(patch)=>{
      ...
      if(readerArticleRef.current && readerArticleRef.current.id===articleId) setReaderArticle(prev=>prev?{...prev,...patch}:prev);
    };
    setFlag({aiLoading:true,aiFailed:false});
    const article = articles.find(a=>a.id===articleId) || readerArticleRef.current;
    if(!article){ setFlag({aiLoading:false}); return; }
    const result=await generateAISummary(article.headline,article.description);
    if(result){ setFlag({aiLoading:false,aiSummary:result,aiFailed:false}); }
    else { setFlag({aiLoading:false,aiSummary:null,aiFailed:true}); }
  },[articles]);

  // Keep a ref to readerArticle so handleGenerateAI (used inside ReaderView too) can update it
  const readerArticleRef = useRef(null);
  useEffect(()=>{ readerArticleRef.current = readerArticle; },[readerArticle]);

  // Skip: advance the cursor past this card. Card remains in the pool (can scroll back via category reload).
  const handleSkip=(article)=>{
    setCursor(prev=>prev+1);
    showToast("Skipped");
  };

  // Read: open in-app reader WITHOUT removing the card from the stack.
  const handleRead=(article)=>{ setReaderArticle(article); };

  // Close reader: simply close it — cursor & articles are untouched, so the
  // SAME card the user was on before is still on top. True continuity.
  const handleCloseReader=()=>{ setReaderArticle(null); };
    ...
    <div style={{minHeight:"100vh",background:"#0D0D0D",fontFamily:"'Inter',-apple-system,sans-serif",color:"#fff",display:"flex",flexDirection:"column",maxWidth:420,margin:"0 auto",position:"relative",fontSize:tsz}}>
      ...
      {activeTab==="home"&&<>
        ...
        <div style={{flex:1,padding:"20px 20px 110px"}}>
          ...
          :visibleStack.length>0?<div style={{position:"relative",height:600}}>{visibleStack.map((article,i)=><NewsCard key={article.id} article={article} isTop={i===0} stackIndex={i} onSkip={handleSkip} onRead={handleRead} onSave={handleSave} onGenerateAI={handleGenerateAI}/>)}</div>
      ...
      {activeTab==="settings"&&<div style={{flex:1,padding:"20px 20px 100px",overflowY:"auto"}}>
        ...
        <div style={{marginBottom:12}}>
          ...
          <div style={{background:"#1A1A1A",borderRadius:14,padding:20,border:"1px solid #222"}}>
            {[["App","Aloka"],["Version","0.6.0 Beta"],["Tagline","News, clearly."],["Name origin","Sinhala — light"]].map(([k,v])=>(
